...
void piece::movesRook(piece * p, int x, int y){
    int x1 = x + 1;
    while(x1 < 8){
...
void piece::movesPawn(piece * p, int x, int y){
    if(p->wb = 0){
...
void piece::movesBish(piece * p, int x, int y){
    int y1 = y+1;
    int x1 = x+1;
    while(y1 < 8 && x1 < 8){
...
void piece::movesKnit(piece * p, int x, int y){
    if(y+2 < 8){
...
void piece::movesKing(piece * p, int x, int y){
    if(x+1 < 8){
...
void piece::setMoves(piece * p, int x, int y){//gives piece and coordinates for a location of a peice on the board, assuming x: 0-7 inclusive, y: 0-7 inclusive.
    //clearMoves(p);
    if(p->type == "b"){
        movesBish(p, x, y);
    }
